...
[honggfuzz](https://github.com/google/honggfuzz) ⭐ 3,377 | 🐛 30 | 🌐 C | 📅 2026-06-19 - A general-purpose, easy-to-use fuzzer with interesting analysis options. Supports feedback-driven fuzzing based on code coverage. Supports GNU/Linux, FreeBSD, Mac OSX and Android.
...
[Metasploit Framework](https://github.com/rapid7/metasploit-framework) ⭐ 38,956 | 🐛 613 | 🌐 Ruby | 📅 2026-09-07 - A framework which contains some fuzzing capabilities via Auxiliary modules.
...
[AFLNet](https://github.com/aflnet/aflnet) ⭐ 1,013 | 🐛 43 | 🌐 C | 📅 2025-05-26 - A Greybox Fuzzer for Network Protocols (an extention of AFL).
...
[syzkaller](https://github.com/google/syzkaller) ⭐ 6,320 | 🐛 629 | 🌐 Go | 📅 2026-09-07 - Distributed, unsupervised, coverage-guided Linux syscall fuzzer.
...
[Jazzer](https://github.com/CodeIntelligenceTesting/jazzer) ⭐ 1,255 | 🐛 49 | 🌐 Java | 📅 2026-09-07 - A coverage-guided, in-process fuzzer for the Java Virtual Machine based on libFuzzer.
...
[Z3](https://github.com/Z3Prover/z3) ⭐ 12,651 | 🐛 44 | 🌐 C++ | 📅 2026-09-08 - A theorem prover from Microsoft Research.
...
[Capstone](https://github.com/aquynh/capstone) ⭐ 8,999 | 🐛 358 | 🌐 C | 📅 2026-09-06 - Capstone is a lightweight multi-platform, multi-architecture disassembly framework.
...
[PDF Test Corpus from Mozilla](https://github.com/mozilla/pdf.js/tree/master/test/pdfs) ⭐ 53,846 | 🐛 418 | 🌐 JavaScript | 📅 2026-09-07
