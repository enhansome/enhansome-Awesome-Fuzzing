...
[Modern Binary Exploitation ( RPISEC ) - Chapter 15 ](https://github.com/RPISEC/MBE) ⭐ 6,047 | 🐛 11 | 🌐 C | 📅 2021-12-09 - by RPISEC.
...
[Fuzzing with AFL Workshop - a set of challenges on real vulnerabilities](https://github.com/ThalesIgnite/afl-training) ⭐ 1,285 | 🐛 6 | 🌐 C | 📅 2022-10-12
...
[honggfuzz](https://github.com/google/honggfuzz) ⭐ 3,382 | 🐛 30 | 🌐 C | 📅 2026-06-19 - A general-purpose, easy-to-use fuzzer with interesting analysis options. Supports feedback-driven fuzzing based on code coverage. Supports GNU/Linux, FreeBSD, Mac OSX and Android.
...
[boofuzz](https://github.com/jtpereyda/boofuzz) ⭐ 2,357 | 🐛 101 | 🌐 Python | 📅 2026-08-06 -  A fork and successor of Sulley framework.

[Spike](http://www.immunitysec.com/downloads/SPIKE2.9.tgz) - A fuzzer development framework like sulley, a predecessor of sulley.

[Metasploit Framework](https://github.com/rapid7/metasploit-framework) ⭐ 39,002 | 🐛 610 | 🌐 Ruby | 📅 2026-09-11 - A framework which contains some fuzzing capabilities via Auxiliary modules.
...
[AFLNet](https://github.com/aflnet/aflnet) ⭐ 1,014 | 🐛 43 | 🌐 C | 📅 2025-05-26 - A Greybox Fuzzer for Network Protocols (an extention of AFL).
...
[Grizzly](https://github.com/MozillaSecurity/grizzly) ⭐ 322 | 🐛 24 | 🌐 Python | 📅 2026-08-20 - A cross-platform browser fuzzing framework
...
[syzkaller](https://github.com/google/syzkaller) ⭐ 6,321 | 🐛 628 | 🌐 Go | 📅 2026-09-11 - Distributed, unsupervised, coverage-guided Linux syscall fuzzer.
...
[Jazzer](https://github.com/CodeIntelligenceTesting/jazzer) ⭐ 1,256 | 🐛 49 | 🌐 Java | 📅 2026-09-09 - A coverage-guided, in-process fuzzer for the Java Virtual Machine based on libFuzzer.
...
[Z3](https://github.com/Z3Prover/z3) ⭐ 12,659 | 🐛 47 | 🌐 C++ | 📅 2026-09-13 - A theorem prover from Microsoft Research.
...
[Capstone](https://github.com/aquynh/capstone) ⭐ 9,014 | 🐛 358 | 🌐 C | 📅 2026-09-10 - Capstone is a lightweight multi-platform, multi-architecture disassembly framework.
...
[vulnserver](https://github.com/stephenbradshaw/vulnserver) ⭐ 1,130 | 🐛 1 | 🌐 C | 📅 2020-10-09 - A vulnerable server for testing fuzzers.

##### Samples files for seeding during fuzzing:

<https://files.fuzzing-project.org/>

[PDF Test Corpus from Mozilla](https://github.com/mozilla/pdf.js/tree/master/test/pdfs) ⭐ 53,863 | 🐛 417 | 🌐 JavaScript | 📅 2026-09-13
...
* [and these awesome people](https://github.com/secfigo/Awesome-Fuzzing/graphs/contributors) ⭐ 5,912 | 🐛 12 | 📅 2024-04-03
