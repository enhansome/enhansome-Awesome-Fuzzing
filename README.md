...
[honggfuzz](https://github.com/google/honggfuzz) ⭐ 3,387 | 🐛 31 | 🌐 C | 📅 2026-09-25 - A general-purpose, easy-to-use fuzzer with interesting analysis options. Supports feedback-driven fuzzing based on code coverage. Supports GNU/Linux, FreeBSD, Mac OSX and Android.
...
[radamsa](https://github.com/aoh/radamsa) ⭐ 1,297 | 🐛 6 | 📅 2018-08-14 - A general purpose fuzzer and test case generator.
...
[boofuzz](https://github.com/jtpereyda/boofuzz) ⭐ 2,361 | 🐛 101 | 🌐 Python | 📅 2026-09-21 -  A fork and successor of Sulley framework.
