# Welcome to Awesome Fuzzing with stars
...
[Modern Binary Exploitation ( RPISEC ) - Chapter 15 ](https://github.com/RPISEC/MBE) ⭐ 6,024 | 🐛 11 | 🌐 C | 📅 2021-12-09 - by RPISEC.
...
[Attacking Antivirus Software's Kernel Driver](https://github.com/bee13oy/AV_Kernel_Vulns/tree/master/Zer0Con2017) ⭐ 264 | 🐛 0 | 🌐 C++ | 📅 2017-07-06

[Fuzzing the Windows Kernel - OffensiveCon 2020](https://github.com/yoava333/presentations/blob/master/Fuzzing%20the%20Windows%20Kernel%20-%20OffensiveCon%202020.pdf) ⭐ 34 | 🐛 1 | 📅 2020-02-18
...
[Root Cause Analysis of the Crash during Fuzzing](https://www.corelan.be/index.php/2013/02/26/root-cause-analysis-memory-corruption-vulnerabilities/) - by Corelan Team.
...
[Fuzzing capstone using AFL persistent mode](https://toastedcornflakes.github.io/articles/fuzzing_capstone_with_afl.html) - by @toasted\_flakes
...
[libFuzzer Tutorial](https://github.com/google/fuzzing/blob/master/tutorial/libFuzzerTutorial.md) ⚠️ Archived

[Hunting for bugs in VirtualBox (First Take)](http://blog.paulch.ru/2020-07-26-hunting-for-bugs-in-virtualbox-first-take.html)

[libFuzzer Workshop: "Modern fuzzing of C/C++ Projects"](https://github.com/Dor1s/libfuzzer-workshop) ⭐ 1,307 | 🐛 3 | 🌐 C++ | 📅 2023-06-29
...
[Building A Feedback Fuzzer](https://blog.fadyothman.com/tag/myfuzzer/) - by @fady\_othman
...
[Cloudfuzzer](https://github.com/ouspg/cloudfuzzer) ⭐ 23 | 🐛 9 | 🌐 Shell | 📅 2017-04-21 - Cloud fuzzing framework which makes it possible to easily run automated fuzz-testing in cloud environments.
...
[Jackalope](https://github.com/googleprojectzero/Jackalope) ⭐ 1,377 | 🐛 28 | 🌐 C++ | 📅 2026-07-03
...
[Win AFL](https://github.com/googleprojectzero/winafl) ⭐ 2,598 | 🐛 170 | 🌐 C | 📅 2026-03-13 - A fork of AFL for fuzzing Windows binaries
...
[MozPeach](https://github.com/MozillaSecurity/peach) ⚠️ Archived - A fork of peach 2.7 by Mozilla Security.
...
[grammarinator](https://github.com/renatahodovan/grammarinator) ⭐ 435 | 🐛 14 | 🌐 Python | 📅 2026-08-08 - Fuzzing tool for file formats based on ANTLR v4 grammars (lots of grammars already available from the ANTLR project).
...
[Sulley](https://github.com/OpenRCE/sulley) ⭐ 1,449 | 🐛 56 | 🌐 Python | 📅 2020-12-29 -  A fuzzer development and fuzz testing framework consisting of multiple extensible components by Pedram Amini.
...
[Metasploit Framework](https://github.com/rapid7/metasploit-framework) ⭐ 38,795 | 🐛 610 | 🌐 Ruby | 📅 2026-08-12 - A framework which contains some fuzzing capabilities via Auxiliary modules.
...
[AFL (w/ networking patch)](https://github.com/jdbirdwell/afl) ⭐ 199 | 🐛 9 | 🌐 C | 📅 2018-12-03 - An unofficial american fuzzy lop capable of network fuzzing.

[AFLNet](https://github.com/aflnet/aflnet) ⭐ 1,010 | 🐛 43 | 🌐 C | 📅 2025-05-26 - A Greybox Fuzzer for Network Protocols (an extention of AFL).

[Pulsar](https://github.com/hgascon/pulsar) ⭐ 354 | 🐛 1 | 🌐 Python | 📅 2022-06-07 - Protocol Learning, Simulation and Stateful Fuzzer.

### Browser Fuzzing

[BFuzz](https://github.com/RootUp/BFuzz) ⭐ 318 | 🐛 0 | 🌐 HTML | 📅 2022-12-05 - An input based, browser fuzzing framework.
[Fuzzinator](https://github.com/renatahodovan/fuzzinator) ⭐ 195 | 🐛 1 | 🌐 Python | 📅 2025-11-23 - Fuzzinator Random Testing Framework
[Grizzly](https://github.com/MozillaSecurity/grizzly) ⭐ 322 | 🐛 24 | 🌐 Python | 📅 2026-07-30 - A cross-platform browser fuzzing framework

### Misc

*Other notable fuzzers like Kernel Fuzzers, general purpose fuzzer etc.,*

[Choronzon](https://github.com/CENSUS/choronzon) ⭐ 272 | 🐛 2 | 🌐 Python | 📅 2024-05-05 - An evolutionary knowledge-based fuzzer
...
[gramfuzz](https://github.com/d0c-s4vage/gramfuzz) ⭐ 259 | 🐛 9 | 🌐 Python | 📅 2020-10-02 - A grammar-based fuzzer that lets one define complex grammars to model text and binary data formats

[KernelFuzzer](https://github.com/mwrlabs/KernelFuzzer) ⭐ 457 | 🐛 3 | 🌐 C | 📅 2018-10-11 - Cross Platform Kernel Fuzzer Framework.

[honggfuzz](http://honggfuzz.com/) - A general-purpose, easy-to-use fuzzer with interesting analysis options.

[Hodor Fuzzer](https://github.com/nccgroup/hodor) ⭐ 129 | 🐛 0 | 🌐 Python | 📅 2016-08-31 - Yet Another general purpose fuzzer.
...
[syzkaller](https://github.com/google/syzkaller) ⭐ 6,297 | 🐛 620 | 🌐 Go | 📅 2026-08-12 - Distributed, unsupervised, coverage-guided Linux syscall fuzzer.
...
[Jazzer](https://github.com/CodeIntelligenceTesting/jazzer) ⭐ 1,249 | 🐛 46 | 🌐 Java | 📅 2026-08-12 - A coverage-guided, in-process fuzzer for the Java Virtual Machine based on libFuzzer.
...
[WebGL Fuzzer](https://github.com/ant4g0nist/webgl-fuzzer) ⭐ 39 | 🐛 0 | 🌐 JavaScript | 📅 2023-03-13 - WebGL Fuzzer
...
[kfetch-toolkit](https://github.com/j00ru/kfetch-toolkit) ⚠️ Archived - Tool to perform advanced logging of memory references performed by operating systems’ kernels

[moflow](https://github.com/vrtadmin/moflow) ⚠️ Archived - A software security framework containing tools for vulnerability, discovery, and triage.

### Symbolic Execution SAT and SMT Solvers

[Z3](https://github.com/Z3Prover/z3) ⭐ 12,550 | 🐛 93 | 🌐 C++ | 📅 2026-08-13 - A theorem prover from Microsoft Research.
...
[Mona.py ( Plugin for windbg and Immunity dbg )](https://github.com/corelan/mona/) ⚠️ Archived - Awesome tools that makes life easy for exploit developers.
...
[Capstone](https://github.com/aquynh/capstone) ⭐ 8,945 | 🐛 360 | 🌐 C | 📅 2026-08-12 - Capstone is a lightweight multi-platform, multi-architecture disassembly framework.
...
[vulnserver](https://github.com/stephenbradshaw/vulnserver) ⭐ 1,129 | 🐛 1 | 🌐 C | 📅 2020-10-09 - A vulnerable server for testing fuzzers.

##### Samples files for seeding during fuzzing:

<https://files.fuzzing-project.org/>

[PDF Test Corpus from Mozilla](https://github.com/mozilla/pdf.js/tree/master/test/pdfs) ⭐ 53,728 | 🐛 423 | 🌐 JavaScript | 📅 2026-08-12
...
[Awesome Directed Fuzzing](https://github.com/strongcourage/awesome-directed-fuzzing) ⭐ 592 | 🐛 0 | 📅 2026-08-07: A curated list of awesome directed fuzzing research papers.
